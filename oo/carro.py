...
class Direcao:
    _direita = {'Norte': 'Leste', 'Leste': 'Sul', 'Sul': 'Oeste', 'Oeste': 'Norte'}
    _esquerda = {'Norte': 'Oeste', 'Oeste': 'Sul', 'Sul': 'Leste', 'Leste': 'Norte'}

    def __init__(self, valor='Norte'):
        self.valor = valor

    def girar_a_direita(self):
        self.valor = self._direita[self.valor]

    def girar_a_esquerda(self):
        self.valor = self._esquerda[self.valor]
